...
pie title Current Portfolio Allocation
    "Cash (US 3-Month T-Bill)" : 28.0
    "SRLN (Senior Loan ETF)" : 9.6
    "USHY (High Yield Bond)" : 10.6
    "IEF (7-10 Year Treasury)" : 11.5
    "MA (Mastercard)" : 12.5
    "LQD (Inv Grade Corp Bond)" : 13.4
    "USIG (Broad Inv Grade Corp)" : 14.4
```

**Suggested Allocation (Pie Chart)**
```mermaid
pie title Suggested Portfolio Allocation
    "Cash (US 3-Month T-Bill)" : 16.1
    "SRLN (Senior Loan ETF)" : 9.6
    "USHY (High Yield Bond)" : 10.6
    "IEF (7-10 Year Treasury)" : 11.5
    "LQD (Inv Grade Corp Bond)" : 13.4
    "USIG (Broad Inv Grade Corp)" : 14.4
    "N02952 (CMT Callable Note)" : 16.1
    "FLOT (Floating Rate Bond ETF)" : 8.2
```
