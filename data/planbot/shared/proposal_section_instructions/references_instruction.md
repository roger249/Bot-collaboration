...
```yaml
instructions: |
- List any local references that used, such as client profiles, product_catalog, financial_needs.
...
- Show the time/date in timezone of the server this proposal is generated.
```
