...
- Please validate the portfolio allocation such that 
    - Total adds up to 0% for the change column
    - The adds up to 100% for suggested column.
    - Compute the allocation of the current column by simple sum.  No constraint is applied.
