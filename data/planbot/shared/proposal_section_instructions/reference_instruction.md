...
instructions: |
  ...
  - Client Profile: client demographics, profile, and holdings documents.
...
- Client Profile: PB-HK-000001-8_demographics.md, PB-HK-000001-8_holdings.csv (Planbot Internal Data)
- Product Catalog: Overview of product catalog.md, selected_etf.csv (Planbot Internal Data)
